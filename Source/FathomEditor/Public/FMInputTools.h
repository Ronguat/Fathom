...
#include "FMInputTools.generated.h"
 ...
 */
UCLASS()
class FATHOMEDITOR_API UFMInputTools : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()

public:
	/** One press-and-release-worth of value on an action, delivered to the next input tick. */
	UFUNCTION(BlueprintCallable, Category="Fathom|Input")
	 ...
	 *
	 *  Key state persists between the edges as it does on a keyboard, so a hold is a press and a release
